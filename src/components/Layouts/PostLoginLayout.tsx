      ...
      <div>
        ...
        <div className="flex flex-row">
          ...
          <div className="basis-1/1 w-screen  ">
            <nav className="flex items-center justify-between  lg:mt-0 md:mt-14 sm:mt-14   flex-wrap bg-bgLight p-4 shadow-md sticky top-0 z-10 w-full">
              <div className="flex items-center flex-shrink-0 text-white">
                <Image
                  src={logo}
                  className="lg:h-9 lg:w-32 w-20 h-6 lg:block md:block sm:block hidden  "
                  alt=""
                />
              </div>
              ...
              >
                ...
                <div className="lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-7 lg:mx-0 md:mx-4 sm:mx-4 mx-4  lg:mt-2 md:mt-4  sm:mt-4 mt-6">
                  <a className=" lg:mt-0 font-bold  text-sm text-black-500 ">
