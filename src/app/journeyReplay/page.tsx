  ...
  return <div >
    ...
    <div className="grid lg:grid-cols-2  md:grid-cols-1  sm:grid-cols-1  px-4 text-start">
      <div className="lg:col-span-1 md:col-span-1  py-5">
        <div className="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 gap-5">
          ...
          <div className="lg:col-span-2 md:col-span-2 sm:col-span-2 mt-1">
            <input type="radio" className="w-5 h-4  " name="bilal" />
            <label className=" " > &nbsp;&nbsp;Today</label>
          </div>

          <div className="lg:col-span-2 md:col-span-3 sm:col-span-3 mt-1">
            <input type="radio" className="w-5 h-4  " name="bilal" />
          ...
          <div className="lg:col-span-2 md:col-span-2 sm:col-span-3 mt-1">
            <input type="radio" className="w-5 h-4  " name="bilal" />
