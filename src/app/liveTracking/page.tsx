        ...
        <div className="flex flex-row">
            <div className="basis-20 py-3 bg-[#29303b] h-screen">
                <button
                    ...
                    title="aWQiOjEyMDd9&">
                    <svg className="w-20 h-14 py-3  border-y-2 mt-12  text-[white]  text-white-10 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                    ...
                    data-te-ripple-color="light"
                    title="aWQiOjEyMDd9&">
                    <svg className="w-20 h-14 py-3  border-y-2 -my-2  text-[white]  text-white-10  dark:text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">  <circle cx="12" cy="12" r="10" />  <polygon points="10 8 16 12 10 16 10 8" /></svg>
                </button>
                ...
                <nav className="flex items-center justify-between flex-wrap bg-gray-50 p-4">
                    ...
                    <div className="w-full block flex-grow lg:flex lg:items-center text-end lg:w-auto">
                        <div className="text-sm lg:flex-grow">
                            <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-[#00B56C]  mr-4">
                                Tester <span className='text-black'> &nbsp; 8/30/2023, 2:25:59 PM</span>
                            </a>
                        ...
                        <div>
                            <a href="#" className="inline-block text-sm px-4 py-2 leading-none lg:mt-0">

                                <img className="inline-block h-10 -my-4 w-10 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                            </a>
                        </div>
                    </div>
                </nav>
