  ...
  return <div >
    ...
    <Paper sx={{ width: '98%' }} className='bg-green-50 ms-3 mr-3 mt-3'>
      ...
      <div className='flex lg: justify-center sm:justify-start'>
        <button onClick={handleOpen} className="bg-[#00B56C] px-4 py-1 m-5 text-white rounded-md"> Assign To A Vehicle</button>
      </div>
      <Modal
        ...
        <Fade in={open}>
          <Box sx={style}>
            <Typography id="transition-modal-title" variant="h6" component="h2" className='text-black'>
              <p className='bg-[#00B56C]  px-4 text-white w-full '>Assign vehicle to driver</p>
            </Typography>
